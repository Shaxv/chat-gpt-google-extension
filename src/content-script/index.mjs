...
async function run(question) {
  ...
  port.onMessage.addListener(function (msg) {
    if (msg.answer) {
      container.innerHTML = '<p><a href="https://chat.openai.com/chat" target="_blank" class="prefix">ChatGPT:</a><br/><div></div></p>';
      container.querySelector("div").innerHTML = msg.answer;
